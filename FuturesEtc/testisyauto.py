...
try:
	...
	ndevices = u.discover()
	print ndevices, 'devices detected'

	u.selectigd()
	print 'local IP address :',u.lanaddr
	externalipaddress = u.externalipaddress()
	print 'external ip :', externalipaddress
	...
	b = u.addportmapping(eport, 'TCP', u.lanaddr, httpd.server_port,'UPnP IGD Tester port %u'%eport, '')
	if b:
